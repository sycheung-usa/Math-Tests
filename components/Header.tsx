...
const Header: React.FC<HeaderProps> = ({ onHomeClick, onGradeSwitch }) => {
  return (
    <header className="bg-white shadow-sm border-b border-sky-100 py-4 px-6 sticky top-0 z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-6 text-sky-600 font-medium items-center">
          ...
          <a href="https://www.cusdk8.org/" target="_blank" rel="noreferrer" className="text-amber-500 hover:text-amber-600 text-sm">CUSD Official</a>
          <button 
            onClick={onHomeClick}
            className="bg-red-50 text-red-500 px-4 py-2 rounded-xl text-sm font-bold hover:bg-red-500 hover:text-white transition-all shadow-sm"
          >
            Quit Explorer
          </button>
        </div>
